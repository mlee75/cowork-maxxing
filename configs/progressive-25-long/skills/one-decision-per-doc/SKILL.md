---
name: one-decision-per-doc
description: Rule on scope for decision documents, memos, and proposals. Use when a document asks a reader to approve, choose, or decide something.
---
