---
name: dates-explicit
description: Rule for writing dates and deadlines in documents, notes, and messages. Use whenever output contains a date, a deadline, a schedule, or a relative time reference.
---
