---
name: acronyms-expanded
description: Rule for acronyms, initialisms, and internal shorthand in written output. Use when drafting anything that will be read outside the team that wrote it.
---
