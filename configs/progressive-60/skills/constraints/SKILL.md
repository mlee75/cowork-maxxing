---
name: constraints
description: Rule for working within fixed constraints on scope, budget, headcount, or time. Use when asked to prioritise, cut, choose under a cap, or decide what does not make the list.
---
