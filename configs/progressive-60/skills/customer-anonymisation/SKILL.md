---
name: customer-anonymisation
description: Rule for referring to customers and accounts in internal and external documents. Use whenever output names a customer, account, or identifiable user.
---
