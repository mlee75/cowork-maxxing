...
tier: 1
description: Rule for stating compliance, certification, security, or data-residency capabilities in any external-facing text. Use when drafting announcements, marketing copy, sales material, questionnaire responses, or anything a customer will read that touches security, privacy, residency, or certification.
---
