...
id: glossary-terms
tier: 2
description: Rule on using defined internal terms consistently. Use when a document uses a term that has a specific internal meaning — a plan name, a lifecycle stage, a metric, or a status.
---
